                    ...
                    <div className="flex flex-col">
                        ...
                        >
                            ...
                            <div className="mt-6 flex flex-col items-center gap-1">
                                ...
                                <span className="text-[10px] text-blue-600 font-black uppercase tracking-widest bg-blue-50 px-3 py-1 rounded-full">{isDragging ? 'Release to upload' : 'Maximum 5 images'}</span>
                            </div>
                            <input
                                type="file"
                                ref={fileInputRef}
